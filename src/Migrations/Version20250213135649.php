...
SQL;
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE public_key_credential_sources CHANGE id id VARCHAR(36) NOT NULL');
        $this->addSql('ALTER TABLE public_key_credential_sources CHANGE public_key_credential_id public_key_credential_id TINYTEXT NOT NULL, CHANGE transports transports JSON NOT NULL COMMENT \'(DC2Type:json)\', CHANGE other_ui other_ui JSON DEFAULT NULL COMMENT \'(DC2Type:json)\'');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_6AD0B4DF72A8BD77 ON public_key_credential_sources (public_key_credential_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE public_key_credential_sources CHANGE id id INT AUTO_INCREMENT NOT NULL');
        $this->addSql('DROP INDEX UNIQ_6AD0B4DF72A8BD77 ON public_key_credential_sources');
        $this->addSql('ALTER TABLE public_key_credential_sources CHANGE public_key_credential_id public_key_credential_id LONGTEXT NOT NULL, CHANGE transports transports LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', CHANGE other_ui other_ui LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\'');
    }
}
